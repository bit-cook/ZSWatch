...
export const fetchArtifacts = async (numRuns = 5) => {
  let firmwares = [];
  try {
...
export const downloadFirmware = (runId, artifactId) => {
  const downloadUrl = `https://github.com/${GITHUB_CONFIG.owner}/${GITHUB_CONFIG.repo}/actions/runs/${runId}/artifacts/${artifactId}`;
